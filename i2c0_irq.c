...
// subroutine to write a byte to a device register
 //device 7b I2C address in upper 7 bits of register (address<<1)
 //reg: 8b register number
 //data: 8b data to write to register
